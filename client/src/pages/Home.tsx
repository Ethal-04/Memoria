  ...
  return (
    <div className="max-w-6xl mx-auto px-6 md:px-10 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="font-poppins text-3xl md:text-4xl font-semibold leading-tight mb-6">
              Cherish memories and find <span className="text-lavender">comfort</span> in connection
            </h2>
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/create">
                <a className="px-8 py-3 bg-gradient-to-r from-lavender to-teal text-white rounded-full font-medium shadow-soft hover:shadow-medium transition-all">
                  Create a Memory Companion
                </a>
              </Link>
              <a href="#learn" className="px-8 py-3 border border-lavender text-lavender rounded-full font-medium hover:bg-lavender/5 transition-all">
                Learn More
              </a>
            </div>
          </div>
          <div className="relative">
            <div className="aspect-[4/3] bg-gradient-to-br from-lavender/20 to-teal/20 rounded-2xl overflow-hidden shadow-medium">
              <img 
            ...
            <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-gradient-to-br from-blue/20 to-green/20 rounded-full blur-2xl -z-10"></div>
            <div className="absolute -top-10 -left-10 w-48 h-48 bg-gradient-to-br from-lavender/20 to-teal/20 rounded-full blur-2xl -z-10"></div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-20" id="learn">
        <h2 className="font-poppins text-2xl md:text-3xl font-semibold text-center mb-12">How Memoria Supports Your Journey</h2>
        
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-soft flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-lavender/10 flex items-center justify-center mb-6">
              <i className="fa-solid fa-image text-lavender text-xl"></i>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-soft flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-teal/10 flex items-center justify-center mb-6">
              <i className="fa-solid fa-comments text-teal text-xl"></i>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-soft flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-blue/10 flex items-center justify-center mb-6">
              <i className="fa-solid fa-headphones text-blue text-xl"></i>
            </div>
      ...
      <section className="mb-20">
        <h2 className="font-poppins text-2xl md:text-3xl font-semibold text-center mb-4">Personal Journeys</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-lavender/5 to-teal/5 p-8 rounded-xl shadow-soft">
